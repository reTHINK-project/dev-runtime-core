...
class RuntimeUA {
  ...
  constructor(runtimeFactory, domain) {
    ...
    _this.identityModule = new IdentityModule(runtimeURL, _this.runtimeCapabilities, _this.storageManager);
    ...
    _this.registry = new Registry(runtimeURL, appSandbox, _this.identityModule, _this.runtimeCatalogue, _this.runtimeCapabilities, _this.storageManager);
    ...
    _this.policyEngine = new PEP(new RuntimeCoreCtx(_this.identityModule, _this.registry, _this.storageManager));
