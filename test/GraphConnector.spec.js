...
// variables
let runtimeURL = 'runtime://localhost/2707';
...
getRegistry.then(function(registry) {
    describe('Graph Connector', function() {
        ...
        describe('create mock address book', function() {
            ...
            //graphConnector.addContact('OxYHdymW84P8IToxJRKdpgq8TDT2CMHtgucPPBoxlDA', 'Alice', 'Wonderland');
            //var expected = new GraphConnectorContactData('OxYHdymW84P8IToxJRKdpgq8TDT2CMHtgucPPBoxlDA', 'Alice', 'Wonderland');
            //var expectedEdit = new GraphConnectorContactData('cptACC4A6tkDyyJ7uHbiResYPf18aFzmdXFRayYrax4', 'Joey', 'Wunderlander');

            //adding GUID for the owner for testing purposes
            graphConnector.globalRegistryRecord.guid = 'o4RyYnkZX6KkyTfvnM5Q9NKJzOFvMXXNwsZBHQsIAI0';
            ...
            it('Adding a groupname to a contact', function() {
                ...
                let resultTrue = graphConnector.addContact('OxYHdymW84P8IToxJRKdpgq8TDT2CMHtgucPPBoxlDA', 'john', 'snow');
                //let resultTrue = graphConnector.addGroupName('OxYHdymW84P8IToxJRKdpgq8TDT2CMHtgucPPBoxlDA', 'Winterfell');
            ...
            /*            it('test privacy setting for contacts', function() {
                            ...
                            graphConnector.addContact('OxYHdymW84P8IToxJRKdpgq8TDT2CMHtgucPPBoxlDA', 'Alice', 'Wonderland');
                            graphConnector.calculateBloomFilter1Hop();
                            expect(graphConnector.contactsBloomFilter1Hop.test('OxYHdymW84P8IToxJRKdpgq8TDT2CMHtgucPPBoxlDA')).to.equal(true);

                            // set private
                            graphConnector.getContact('Alice')[0].privateContact = true;
                            graphConnector.calculateBloomFilter1Hop();
                            expect(graphConnector.contactsBloomFilter1Hop.test('OxYHdymW84P8IToxJRKdpgq8TDT2CMHtgucPPBoxlDA')).to.equal(false);
            ...
            /*            it('setting bloom filter of a given contact', function() {
                            ...
                            bf.add('jerry');
                            bf.add('elaine');
                            let tmpGUID = 'OxYHdymW84P8IToxJRKdpgq8TDT2CMHtgucPPBoxlDA';
