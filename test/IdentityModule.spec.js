...
describe('Identity Module tests', function() {
	...
	it('test sendGenerateMessage', function(done){
		...
		identityModule.sendGenerateMessage(contents, origin, loginUrl, idpDomain).then(resMsg => {
			assert.equal(resMsg.assertion, assertion_val, 'Received message is not OK');
		}).then(done,done);
	});	
	...
	it('test getIdentity', function(done) {
		...
		crypto.generateRSAKeyPair().then( keyPair => {;
			identityModule.storeIdentity(returnedAssertionValue, keyPair).then( result =>{
				...
				assert.equal(result.assertion, retrivedID.assertion, 'Retrived ID is not the same');
			}).then(done,done);
		});
	});	
	...
	it('test validateAssertion', function(done){
      ...
      assert.equal(result.contents, validateAssertionValuePopulate.contents, 'Received data is not the expected');
		}).then(done,done);
	});
	...
	it('test selectIdentityForHyperty', function(done){ 
      ...
      log(resMsg);
      let assertValue = resMsg.hasOwnProperty('userProfile') &&
    ...
    assert.equal(identityModule._resolveDomain(''), expectedResult, 'Result is not the expected one');
    assert.equal(identityModule._resolveDomain('google.com'), expectedResult, 'Result is not the expected one');
	})
    ...
    let valueVerificationResult =
        ...
        receivedHash.body.identity === (identity || messageToBeHashedPopulate.body.identity) &&
				receivedHash.body.value === (decryptedValue || messageToBeHashedPopulate.body.value) &&
				receivedHash.body.handshakePhase === messageToBeHashedPopulate.body.handshakePhase;
	...
	it('test _sendReporterSessionKey', function(done){
		...
		let chatKeys = { dataObjectURL: 'comm://localhost/5f8d87fd-c56b-47fc-ad47-28d55f01e23a',
    ...
    let helloMessage = messageForNewChatCrypto
		let keyPair = { public: chatKeysPopulate.hypertyFrom.publicKey,
...
//			}
			...
			}else{ log('msgNodeResponseFunc identity');
...
let chatKeysPopulate = {
	hypertyFrom: { hyperty: 'hyperty://localhost/7339190f-056a-41e1-88ec-18f02146b5bb',
...
messageInfo: { userProfile: undefined,
  idp: 'google.com',
  assertion: '', 
  expires: '1507909486' } 
},  
hypertyTo: {
  ...
  publicKey: undefined,     
  assertion: undefined },  
  keys: { hypertyToSessionKey: undefined,     
...
let encryptMessagePopulate = {
  ...
  body: { handshakePhase: 'senderHello', 
    value: 'NDgsNDksNTIsNTAsMzksMTEsMjM5LDIxMSwxODQsMTg1LDE4NSwxNjEsMTQzLDE0NSwyMDEsMTA4LDg2LDIxNSwyNTUsMTUwLDIyMiw1MSwxNDUsMTQzLDEzMCwxNiwxNTYsMTY5LDMyLDIyNywzNSwyNw==',
    identity: { 
...
let senderHelloMessagePopulate = {
  ...
  body: { 
    ...
    value: 'NDgsNDksNTIsNTAsMzksMTEsMjM5LDIxMSwxODQsMTg1LDE4NSwxNjEsMTQzLDE0NSwyMDEsMTA4LDg2LDIxNSwyNTUsMTUwLDIyMiw1MSwxNDUsMTQzLDEzMCwxNiwxNTYsMTY5LDMyLDIyNywzNSwyNw==', 
    identity: { userProfile: undefined, 
    idp: 'google.com',   
    assertion: '',
    expires: '1507909486' },  
    auth: false 
...
let receiverHelloMessagePopulate = {
  ...
  body:    
    { handshakePhase: 'receiverHello',     
      value: 'NDgsNTAsNTIsNTEsMTUwLDI1MSwzNywxMjMsMzksMjgsNDgsMjksMTE1LDI0NSw5MSwxNDAsNTEsMTM3LDE3MSwyMDUsMTI0LDg3LDE1Myw0MSwyMDIsNzcsOTAsMTg2LDIwNSwxODUsMzMsODA=',     
      identity: { 
        userProfile: undefined,        
        idp: 'google.com',        
        assertion: '',
        expires: '1507909389' 
      },     
      auth: false,     
...
let senderCertificateMessagePopulate = {
  ...
  body: { 
    ...
    value: '',     
    identity: { userProfile: undefined,        
    idp: 'google.com',        
    assertion: '',
    expires: '1507909486'
...
let receiverFinishedMessagePopulate = {
  ...
  body:{ 
    ...
    value: '',  
    identity: { userProfile: undefined,        
    idp: 'google.com',        
    assertion: '',        
    expires: '1507909389' 
...
let reporterSessionKeyMessagePopulate = {
  ...
  body: { 
    ...
    value: ''  ,   
    identity: {
      userProfile: undefined, 
        idp: 'google.com',        
        assertion: '==',
...
let receiverAcknowledgeMessagePopulate = {
  ...
  body: { 
    ...
    value: '',     
    identity: { 
      userProfile: undefined,        
      idp: 'google.com',        
      assertion: '',        expires: '1508004853' },     auth: false,     via: 'runtime://localhost/protostub/ec69047b-c073-cbbc-e100-57fb897d4f8b' 
  },  
  id: 15
};
