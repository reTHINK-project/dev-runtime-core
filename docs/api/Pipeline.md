...
Class: Pipeline {#class-pipeline .page-title}
===============
...
#### <span class="type-signature"></span>new Pipeline() {#Pipeline .name}

Author:

:   -   micaelpedrosa@gmail.com Pipeline Sequencial processor
        of methods. Similar to how Sequential Promise’s work, but better
        fit for message processing.
