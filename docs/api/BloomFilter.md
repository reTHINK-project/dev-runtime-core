...
Class: BloomFilter {#class-bloomfilter .page-title}
==================
...
#### <span class="type-signature"></span>new BloomFilter() {#BloomFilter .name}

Author:

:   -   Jason Davies; adapted and extended by beierle@tu-berlin.de
