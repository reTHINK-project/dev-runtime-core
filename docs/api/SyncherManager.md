...
Class: SyncherManager {#class-synchermanager .page-title}
=====================
...
#### <span class="type-signature"></span>new SyncherManager() {#SyncherManager .name}

Author:

:   -   micaelpedrosa@gmail.com Core Syncronization system.
