# Hyperty Runtime Core [![Build Status](https://travis-ci.org/reTHINK-project/dev-runtime-core.svg?branch=develop-improves-revised-catalogue)](https://travis-ci.org/reTHINK-project/dev-runtime-core)
--------------------
