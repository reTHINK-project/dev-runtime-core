...
// version: 0.5.0
// Last build: Thu Jun 23 2016 17:37:10 GMT+0100 (WEST)
...
},{"babel-runtime/helpers/classCallCheck":9,"babel-runtime/helpers/createClass":10}],93:[function(require,module,exports){
...
},{"../../utils/utils":95,"../Context":92,"babel-runtime/core-js/object/get-prototype-of":4,"babel-runtime/helpers/classCallCheck":9,"babel-runtime/helpers/createClass":10,"babel-runtime/helpers/inherits":11,"babel-runtime/helpers/possibleConstructorReturn":12}],94:[function(require,module,exports){
'use strict';Object.defineProperty(exports,"__esModule",{value:true});var _getPrototypeOf=require('babel-runtime/core-js/object/get-prototype-of');var _getPrototypeOf2=_interopRequireDefault(_getPrototypeOf);var _classCallCheck2=require('babel-runtime/helpers/classCallCheck');var _classCallCheck3=_interopRequireDefault(_classCallCheck2);var _createClass2=require('babel-runtime/helpers/createClass');var _createClass3=_interopRequireDefault(_createClass2);var _possibleConstructorReturn2=require('babel-runtime/helpers/possibleConstructorReturn');var _possibleConstructorReturn3=_interopRequireDefault(_possibleConstructorReturn2);var _inherits2=require('babel-runtime/helpers/inherits');var _inherits3=_interopRequireDefault(_inherits2);var _CommonCtx2=require('./CommonCtx');var _CommonCtx3=_interopRequireDefault(_CommonCtx2);var _utils=require('../../utils/utils');function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}var MessageNodeCtx=function(_CommonCtx){(0,_inherits3.default)(MessageNodeCtx,_CommonCtx);function MessageNodeCtx(){(0,_classCallCheck3.default)(this,MessageNodeCtx);var _this2=(0,_possibleConstructorReturn3.default)(this,(0,_getPrototypeOf2.default)(MessageNodeCtx).call(this));var _this=_this2;_this.policies=_this.loadPolicies();return _this2;}(0,_createClass3.default)(MessageNodeCtx,[{key:'loadPolicies',value:function loadPolicies(){return {};}},{key:'isToVerify',value:function isToVerify(message){var _this=this;var isFromHyperty=(0,_utils.divideURL)(message.from).type==='hyperty';var isFromSM=message.from===_this.runtimeRegistry.runtimeURL+'/sm';var isToSubscription=_this._getLastComponentOfURL(message.to)==='subscription';var isToHyperty=(0,_utils.divideURL)(message.to).type==='hyperty';return isFromSM&&isToSubscription||isFromHyperty&&isToHyperty;}},{key:'authorise',value:function authorise(message){var _this=this;console.log('--- Policy Engine (Message Node)---');console.log(message);message.body=message.body||{};var result=void 0;var isToVerify=_this.isToVerify(message);if(isToVerify){result=_this.applyPolicies(message);var messageAccepted=result.policiesResult[0];return messageAccepted;}else {return true;}}}]);return MessageNodeCtx;}(_CommonCtx3.default);exports.default=MessageNodeCtx;module.exports=exports['default'];

},{"../../utils/utils":95,"./CommonCtx":93,"babel-runtime/core-js/object/get-prototype-of":4,"babel-runtime/helpers/classCallCheck":9,"babel-runtime/helpers/createClass":10,"babel-runtime/helpers/inherits":11,"babel-runtime/helpers/possibleConstructorReturn":12}],95:[function(require,module,exports){
